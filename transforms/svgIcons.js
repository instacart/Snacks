...
const removed = ['addToOrderAndroid', 'arrowEnter', 'arrowLeft', 'compassFilled', 'creditCardFilled', 'dealsIcon', 'faq', 'filterAndroid', 'filterFilled', 'giftcardFilled', 'googleFilled', 'grid', 'gridFilled', 'guaranteedFresh', 'guaranteedFreshFilled', 'iconExit', 'itemsYouveOrdered', 'lightbulbAndroid', 'listsAndRecipesFilled', 'phoneAndroid', 'phoneAndroidFilled', 'popular', 'pricingSame', 'quickAdd', 'receipt', 'request', 'shareAndroid', 'shareAndroid2', 'shareAndroid2Filled', 'shareAndroidFilled', 'tip', 'tipFilled']
const renamed = {
  ...
  checkBold: 'checkmark', minusBold: 'minus', plusBold: 'plus', pricingSameFilled: 'checkmarkCircleFilled', replaceBold: 'replace',
}
