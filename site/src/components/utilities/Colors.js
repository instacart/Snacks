...
export default function Colors() {
  return (
    <Fragment>
      ...
      <div style={group}>
        <Swatch name="White" value={colors.WHITE} inverted />
        <Swatch name="Gray 97" value={colors.GRAY_97} inverted />
        <Swatch name="Gray 93" value={colors.GRAY_93} inverted />
        <Swatch name="Gray 88" value={colors.GRAY_88} inverted />
        <Swatch name="Gray 74" value={colors.GRAY_74} inverted />
