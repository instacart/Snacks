...
it('renders ScrollTrack buttons correctly', () => {
  ...
  // show right arrow
  track.find(ScrollTrack).getElement().showRightArrow()
  ...
  // show left arrow
  track.find(ScrollTrack).getElement().showLeftArrow()
  buttons = track.find('button')
  leftButton = buttons.first()
  rightButton = buttons.last()
  leftButtonStyle = leftButton.props().style
  ...
  // hide both arrows
  track.find(ScrollTrack).getElement().hideArrows()
  buttons = track.find('button')
  leftButton = buttons.first()
  rightButton = buttons.last()
  leftButtonStyle = leftButton.props().style
...
it('onBefore promises & callbacks called correctly', async () => {
  ...
  // show and click back
  track.find(ScrollTrack).getElement().hideRightArrow()
  track.find(ScrollTrack).getElement().showLeftArrow()
