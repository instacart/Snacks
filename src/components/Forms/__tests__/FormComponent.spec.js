...
describe('when a component has a #getValue method', () => {
  it('gets the value from #getValue', () => {
    ...
    expect(wrapper.find('FormComponent').instance().getValue()).toBe(TEST_FORMATTED_VALUE)
    expect(wrapper.find('FormComponent').instance().hasValue()).toBe(true)
  })
})
...
describe('when a component does not have #getValue method, but has value in state', () => {
  it('gets the value from state.value', () => {
    ...
    expect(wrapper.find('FormComponent').instance().getValue()).toBe(TEST_VALUE)
    expect(wrapper.find('FormComponent').instance().hasValue()).toBe(true)
  })
})
...
describe('when a component is required', () => {
  ...
  describe('and the value is null', () => {
    it('#hasValue should be false', () => {
      ...
      expect(wrapper.find('FormComponent').instance().hasValue()).toBe(false)
      expect(wrapper.find('FormComponent').instance().validate()).toBe(false)
    })
  })
  ...
  describe('and the value is present', () => {
    it('#hasValue should be true', () => {
      ...
      expect(wrapper.find('FormComponent').instance().hasValue()).toBe(true)  
      expect(wrapper.find('FormComponent').instance().validate()).toBe(true)
    })
  })
})