...
it('fires the onChange prop', () => {
  ...
  wrapper.find('input').simulate('change', {target: {value: 'MM/DD/YYYY'}})

  // ensure the callback passes both raw and edited versions
  expect(onChange).toBeCalledWith(expect.anything(), 'MM/DD/YYYY', 'MM/DD/YYYY')
  ...
  expect(onChange.mock.calls[1]).toEqual([expect.anything(), '04/27/1993', '04/27/1993'])
